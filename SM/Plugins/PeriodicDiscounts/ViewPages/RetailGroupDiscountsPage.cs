...
{
    public partial class RetailGroupDiscountsPage : UserControl, ITabView
    {
        WeakReference owner;
        RecordIdentifier groupID;

        public RetailGroupDiscountsPage(TabControl owner)
            : this()
        {
            this.owner = new WeakReference(owner);
        }

        public RetailGroupDiscountsPage()
        {
            InitializeComponent();
        ...
        {
            return new RetailGroupDiscountsPage((TabControl)sender);
        }
        ...
        public void LoadLines()
        {
            ...
            List<DiscountOffer> offers = Providers.DiscountOfferData.GetOffersAndPromotionsFromRelation(PluginEntry.DataModel, groupID, DiscountOfferLine.DiscountOfferTypeEnum.RetailGroup);
        ...
        private void lvValues_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            btnsContextButtons.EditButtonEnabled = btnsContextButtons.RemoveButtonEnabled = lvValues.SelectedItems.Count > 0 && (lvValues.SelectedItems[0].SubItems[2].Text == Properties.Resources.Disabled);
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Dictionary<string, object> lineAndOfferDictionary = (Dictionary<string, object>)lvValues.SelectedItems[0].Tag;

            RecordIdentifier offerID;
            RecordIdentifier lineID;
            DiscountOfferLine line;

            DiscountOffer offer = (DiscountOffer)lineAndOfferDictionary["Offer"];
            ...
            switch (offerType)
            {
                case DiscountOffer.PeriodicDiscountOfferTypeEnum.Promotion:
                    ...
                    var editDialog = Dialogs.PromotionLineDialog.CreateForEditing(offerID, lineID);
