...
{
    public partial class RetailDepartmentDiscountsPage : UserControl, ITabView
    {
        WeakReference owner;
        RecordIdentifier groupID;

        public RetailDepartmentDiscountsPage(TabControl owner)
            : this()
        {
            this.owner = new WeakReference(owner);
        }

        public RetailDepartmentDiscountsPage()
        {
            InitializeComponent();
        ...
        {
            return new RetailDepartmentDiscountsPage((TabControl)sender);
        }
        ...
        public void LoadLines()
        {
            ...
            List<DiscountOffer> offers = Providers.DiscountOfferData.GetOffersAndPromotionsFromRelation(PluginEntry.DataModel, groupID, DiscountOfferLine.DiscountOfferTypeEnum.RetailDepartment);
        ...
        private void lvValues_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            btnShowOffer.Enabled = lvValues.SelectedItems.Count > 0;
