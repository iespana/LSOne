...
namespace LSOne.ViewPlugins.KitchenDisplaySystem.PluginComponents.Views
{
    public partial class StyleProfilesView : ViewBase
    {
        ...
        public StyleProfilesView(RecordIdentifier selectedProfileId)
            :this()
        {
        ...
        {
            contexts.Add(new AuditDescriptor("KITCHENDISPLAYSTYLESPROFILESLog", RecordIdentifier.Empty, Properties.Resources.StyleProfiles, false));
        ...
        private void LoadProfiles()
        {
            ...
            List<LSOneKitchenDisplayStyleProfile> profiles = Providers.KitchenDisplayStyleProfileData.GetList(PluginEntry.DataModel);
        ...
        private void btnsEditAddRemove_EditButtonClicked(object sender, EventArgs e)
        {
            ...
            PluginOperationsHelper.ShowStyleProfileView(selectedId);
        }
        ...
        private void btnsEditAddRemove_AddButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                PluginOperationsHelper.ShowStyleProfileView(dlg.Id);
            }          
        }
        ...
        private void btnsEditAddRemove_RemoveButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                PluginOperationsHelper.DeleteStyleProfile((RecordIdentifier)lvProfiles.SelectedItems[0].Tag);
            }
            else
            {
                PluginOperationsHelper.DeleteStyleProfiles(lvProfiles.GetSelectedIDs());
            }
        }
