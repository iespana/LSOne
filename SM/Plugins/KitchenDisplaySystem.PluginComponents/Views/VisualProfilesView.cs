...
namespace LSOne.ViewPlugins.KitchenDisplaySystem.PluginComponents.Views
{
    public partial class VisualProfilesView : ViewBase
    {
        ...
        public VisualProfilesView(RecordIdentifier selectedProfileId)
            :this()
        {
        ...
        {
            contexts.Add(new AuditDescriptor("KITCHENDISPLAYVISUALPROFILESLog", RecordIdentifier.Empty, Properties.Resources.VisualProfiles, false));
        ...
        private void LoadProfiles()
        {
            ...
            List<KitchenDisplayVisualProfile> profiles = Providers.KitchenDisplayVisualProfileData.GetList(PluginEntry.DataModel);
        ...
        private void btnsEditAddRemove_EditButtonClicked(object sender, EventArgs e)
        {
            ...
            PluginOperationsHelper.ShowVisualProfileView(selectedId);
        }
        ...
        private void btnsEditAddRemove_AddButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                PluginOperationsHelper.ShowVisualProfileView(dlg.Id);
            }          
        }
        ...
        private void btnsEditAddRemove_RemoveButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                PluginOperationsHelper.DeleteVisualProfile((RecordIdentifier)lvProfiles.SelectedItems[0].Tag);
            }
            else
            {
                PluginOperationsHelper.DeleteVisualProfiles(lvProfiles.GetSelectedIDs());
            }
        }
