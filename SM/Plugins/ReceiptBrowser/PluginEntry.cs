...
namespace LSOne.ViewPlugins.ReceiptBrowser
{
    public class PluginEntry : IPlugin
    {
        ...
        {
            get { return Properties.Resources.ReceiptBrowser; }
        }
        ...
        {
            operations.AddOperation(Properties.Resources.SearchForReceipt, PluginOperations.ShowFindReceiptSheet, Permission.ReceiptsView);
        }
