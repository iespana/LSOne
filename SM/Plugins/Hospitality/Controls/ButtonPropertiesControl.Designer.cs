...
namespace LSOne.ViewPlugins.Hospitality.Controls
{
    partial class ButtonPropertiesControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.mainLayout.Controls.Add(this.lblTextPosition, 0, 9);
			this.mainLayout.Controls.Add(this.backColorFlowLayout, 1, 6);
			this.mainLayout.Controls.Add(this.lblFontName, 0, 1);
			this.mainLayout.Controls.Add(this.fontStyleFlowLayout, 1, 3);
			this.mainLayout.Controls.Add(this.cmbShape, 1, 8);
			this.mainLayout.Controls.Add(this.fontFlowLayout, 1, 1);
			this.mainLayout.Controls.Add(this.lblShape, 0, 8);
			this.mainLayout.Controls.Add(this.cmbGradientMode, 1, 7);
			this.mainLayout.Controls.Add(this.lblFontSize, 0, 2);
			this.mainLayout.Controls.Add(this.lblGradientMode, 0, 7);
			this.mainLayout.Controls.Add(this.ntbFontSize, 1, 2);
			this.mainLayout.Controls.Add(this.lblFontBold, 0, 3);
			this.mainLayout.Controls.Add(this.cwForeColor, 1, 5);
			this.mainLayout.Controls.Add(this.lblBackColor, 0, 6);
			this.mainLayout.Controls.Add(this.ntbFontCharset, 1, 4);
			this.mainLayout.Controls.Add(this.lblFontColor, 0, 5);
			...
			this.mainLayout.Controls.Add(this.cmbTextPosition, 1, 9);
