...
{
    partial class TransferRequestsSendingPage
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TransferRequestsSendingPage));
            ...
            this.btnsRequests = new LSOne.Controls.ContextButtons();
            ...
            this.lvItems.Columns.Add(this.column14);
            ...
            this.column14.InternalSort = true;
            ...
            // btnsRequests
            // 
            this.btnsRequests.AddButtonEnabled = true;
            resources.ApplyResources(this.btnsRequests, "btnsRequests");
            this.btnsRequests.BackColor = System.Drawing.Color.Transparent;
            this.btnsRequests.Context = LSOne.Controls.ButtonTypes.EditAddRemove;
            this.btnsRequests.EditButtonEnabled = false;
            this.btnsRequests.Name = "btnsRequests";
            this.btnsRequests.RemoveButtonEnabled = true;
            this.btnsRequests.EditButtonClicked += new System.EventHandler(this.btnsRequests_EditButtonClicked);
            this.btnsRequests.AddButtonClicked += new System.EventHandler(this.btnsRequests_AddButtonClicked);
            this.btnsRequests.RemoveButtonClicked += new System.EventHandler(this.btnsRequests_RemoveButtonClicked);
            // 
            // btnSendRequest
            // 
            ...
            this.btnSendRequest.Click += new System.EventHandler(this.btnRequest_Click);
            // 
            // lvRequests
            // 
            ...
            this.lvRequests.Columns.Add(this.column10);
            ...
            this.lvRequests.SelectionChanged += new System.EventHandler(this.lvRequests_SelectionChanged);
            this.lvRequests.CellAction += new LSOne.Controls.CellActionDelegate(this.lvRequests_CellAction);
            this.lvRequests.RowDoubleClick += new LSOne.Controls.RowClickDelegate(this.lvRequests_RowDoubleClick);
            // 
            // column7
            // 
            ...
            this.column7.MinimumWidth = ((short)(5));
            this.column7.Tag = null;
            this.column7.Width = ((short)(30));
            // 
            // column10
            // 
            ...
            this.flowLayoutPanel1.Controls.Add(this.btnSendRequest);
        ...
        private ContextButtons btnsRequests;
