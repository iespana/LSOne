...
namespace LSOne.ViewPlugins.Inventory.Dialogs
{
    public partial class EditFileImportProfileDialog : DialogBase
    {
        ...
        private void LoadCSVImportProfiles(string profileSelectionText)
        {
            ...
            Dictionary<RecordIdentifier, string> importProfiles = Providers.ImportProfileData.GetSelectListOfNonEmptyProfiles(PluginEntry.DataModel).Where(el => el.ImportType == DataLayer.BusinessObjects.Enums.ImportType.StockCounting)
