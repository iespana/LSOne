...
namespace LSOne.ViewPlugins.Administration.DataLayer
{
    internal class DBFieldData : SqlServerDataProviderBase, IDBFieldData
    {
        ...
        public void ClearTable(IConnectionManager entry, string tableName)
        {
        ...
        public void Insert(IConnectionManager entry, string tableName, List<DBField> fields)
        {
            ...
            SqlServerStatement statement = new SqlServerStatement(tableName, !entry.DisableReplicationActionCreation);
