...
namespace LSOne.ViewPlugins.TouchButtons.Controls
{
    public partial class ButtonPropertiesControl : UserControl
    {
        ...
        {
            get { return chkStrikethrough.Checked; }
            set { chkStrikethrough.Checked = value; }
        }
        ...
        {
            PluginOperations.NewStyle(cmbStyle.SelectedData.ID);
        ...
        public PosStyle PosStyle
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    FontStrikethrough = value.FontStrikethrough;
        ...
        public void ToStyle(PosStyle style)
        {
            ...
            style.FontStrikethrough = FontStrikethrough;
        ...
        public bool IsModified(PosStyle style)
        {
            ...
            if (chkStrikethrough.Checked != style.FontStrikethrough) return true;
        ...
        public FontStyle FontStyle
        {
            get
            {
                ...
                if (chkStrikethrough.Checked) { style = style | FontStyle.Strikeout; }
