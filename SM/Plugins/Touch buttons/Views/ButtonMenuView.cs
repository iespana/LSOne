...
namespace LSOne.ViewPlugins.TouchButtons.Views
{
    public partial class ButtonMenuView : ViewBase
    {
        ...
        {
            if (posMenuHeader.DeviceType == DeviceTypeEnum.POS)
                return new HelpSettings("POSButtonMenuView");
            else
                return new HelpSettings("InvButtonMenuView");
        }

        public override void GetAuditDescriptors(List<AuditDescriptor> contexts)
        {
            string descr = posMenuHeader != null && posMenuHeader.DeviceType == DeviceTypeEnum.POS
                                ? Properties.Resources.PosMenuHeader
                                : Properties.Resources.MobileInvMenuHeader;
            contexts.Add(new AuditDescriptor("PosMenuHeader", posMenuHeaderID, descr, true));
        }
        ...
        public string Description
        {
            get
            {
                return (posMenuHeader != null && posMenuHeader.DeviceType == DeviceTypeEnum.POS
                                ? Properties.Resources.PosMenuHeader
                                : Properties.Resources.MobileInvMenuHeader)
                        + ": " + tbID.Text + " - " + tbDescription.Text;
            }
        }
        ...
        protected override void LoadData(bool isRevert)
        {
            if(!isRevert)
            {
                lookAndFeelTab = new TabControl.Tab(Properties.Resources.LookAndFeel, ViewPages.ButtonMenuLookAndFeelPage.CreateInstance);
                buttonsTab = new TabControl.Tab(Properties.Resources.MenuButtons, ViewPages.ButtonMenuButtonsPage.CreateInstance);
            ...
            if(posMenuHeader.DeviceType == DeviceTypeEnum.MobileInventory)
            {
                ntColumns.Enabled = false;
            }
        ...
        protected override bool SaveData()
        {
            ...
            if (curTotalLines > prevTotalLines && actualLines < curTotalLines)
            {
                ...
                if (QuestionDialog.Show(Properties.Resources.AddPosButtonGridMenuLinesQuestion.Replace("#1", Convert.ToString(remaningSpace))) == DialogResult.Yes)
                {
                    ...
                    PluginEntry.Framework.ViewController.NotifyDataChanged(null, DataEntityChangeType.Add, "PosButtonGridMenuHeader", posMenuHeaderID, null);
                }
            }
            ...
            PluginEntry.Framework.ViewController.NotifyDataChanged(null, DataEntityChangeType.Edit, "PosButtonGridMenuHeader", posMenuHeaderID, null);
        ...
        public override void OnDataChanged(DataEntityChangeType changeAction, string objectName, RecordIdentifier changeIdentifier, object param)
        {
            ...
            if (objectName == "PosButtonGridMenuHeader" && changeAction == DataEntityChangeType.Delete && changeIdentifier == posMenuHeaderID)
            {
        ...
        {
            PluginOperations.DeletePosButtonGridMenu(new List<RecordIdentifier> { posMenuHeaderID });
        }
        ...
        {
            new Dialogs.PosButtonGridMenuPreviewDialog(posMenuHeaderID).ShowDialog();
        }
