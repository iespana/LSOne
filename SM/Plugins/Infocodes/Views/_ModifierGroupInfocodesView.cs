...
{
    public partial class ModifierGroupInfocodesView : ViewBase
    {
        private RecordIdentifier selectedID = "";

        public ModifierGroupInfocodesView()
        {
            InitializeComponent();
        ...
        {
            PluginOperations.NewInfocodeGroup(UsageCategories.ItemModifier);
