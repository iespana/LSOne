...
{
    public partial class _GroupInfocodesView : ViewBase
    {
        private RecordIdentifier selectedID = "";

        public _GroupInfocodesView()
        {
            InitializeComponent();
        ...
        void lvItems_Opening(object sender, CancelEventArgs e)
        {
            ...
            item = new ExtendedMenuitem(
                ...
                500,
                new EventHandler(ShowTargetInfocode));
            item.Enabled = btnEditItem.Enabled && lvItems.SelectedItems.Count > 0;
        ...
        private void ShowTargetInfocode(object sender, EventArgs args)
        {
            ...
            PluginOperations.ShowModifierInfocodeSetupSheet(subCode.TriggerCode);
        }
        ...
        private void LoadItems(int sortBy, bool backwards, bool doBestFit, RecordIdentifier idToSelect)
        {
            ...
            items = null; //Providers.InfocodeData.GetList(PluginEntry.DataModel, UsageCategories.None);
            ...
            foreach (Infocode item in items)
            {
                ...
                listItem.SubItems.Add(item.Triggering.ToString());
        ...
        private void lvGroups_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            btnRemove.Enabled = btnEdit.Enabled = (lvGroups.SelectedItems.Count > 0 && PluginEntry.DataModel.HasPermission(Permission.InfocodeEdit));
            ///
        ...
        private void LoadLines()
        {
            ...
            btnEditItem.Enabled = btnRemoveItem.Enabled = items.Count > 0;
        }
        ...
        {
            PluginOperations.NewInfocodeGroup(UsageCategories.None);
        }
        ...
        private void btnAddItem_Click(object sender, EventArgs e)
        {
            if (lvGroups.SelectedItems.Count > 0)
            {
                //PluginOperations.NewGroupSubcode(SelectedGroupID);
            }
        }
        ...
        private void btnEditItem_Click(object sender, EventArgs e)
        {
            ...
            {
                PluginOperations.ShowGroupSubcode((RecordIdentifier)SelectedItemID);
            }
        }
