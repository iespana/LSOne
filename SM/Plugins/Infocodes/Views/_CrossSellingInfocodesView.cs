...
{
    public partial class _CrossSellingInfocodesView : ViewBase
    {
        private RecordIdentifier selectedID = "";

        public _CrossSellingInfocodesView(RecordIdentifier crossSellingInfocodeID)
            : this()
        {
            selectedID = crossSellingInfocodeID;
        }

        public _CrossSellingInfocodesView()
        {
            InitializeComponent();
        ...
        {
            List<Infocode> items = null;
            ListViewItem listItem;

            lvGroups.Items.Clear();

            //items = Providers.InfocodeData.GetInfocodes(PluginEntry.DataModel, new UsageCategories[] { UsageCategories.CrossSelling }, true);
        ...
        private void lvGroups_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            btnRemove.Enabled = btnEdit.Enabled = lvGroups.SelectedItems.Count > 0;
        ...
        {
            PluginOperations.NewInfocode(UsageCategories.CrossSelling);
        }
