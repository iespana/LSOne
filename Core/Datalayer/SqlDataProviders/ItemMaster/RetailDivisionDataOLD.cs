...
namespace LSOne.DataLayer.SqlDataProviders.ItemMaster
{
    ...
    /// </summary>
    public class RetailDivisionDataOLD : SqlServerDataProviderBase
    {
        ...
        */
        ...
        {
            DeleteRecord(entry, "RBOINVENTITEMRETAILDIVISION", "DIVISIONID", divisionId, BusinessObjects.Permission.ManageRetailDivisions);
        }
        ...
        public virtual void Save(IConnectionManager entry, RetailDivision division)
        {
            ...
            ValidateSecurity(entry, BusinessObjects.Permission.ManageRetailDivisions);
