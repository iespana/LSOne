...
namespace LSOne.DataLayer.SqlDataProviders.ItemMaster.Dimensions
{
    ...
    /// </summary>
    public class DimensionData : SqlServerDataProviderBase, IDimensionData
    {
        ...
        private static void PopulateDimensionCombination(IDataReader dr, DimensionCombination dimension)
        {
        ...
        private static void PopulateDimension(IDataReader dr, Dimension dimension)
        {
        ...
        /// </returns>
        public virtual Dimension GetByVariantID(IConnectionManager entry, RecordIdentifier variantNumber)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ...
                var dimensions = Execute<Dimension>(entry, cmd, CommandType.Text, PopulateDimension);

                return dimensions.Count > 0 ? dimensions[0] : new Dimension();
            }
        }
        ...
        /// Returns an instance of <see cref="Dimension"/>
        /// </returns>
        public virtual Dimension Get(IConnectionManager entry, RecordIdentifier itemID, RecordIdentifier variantNumber)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ValidateSecurity(entry);
        ...
        /// Returns an instance of <see cref="Dimension"/>
        /// </returns>
        public virtual Dimension Get(IConnectionManager entry, RecordIdentifier dimensionQuadID)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ValidateSecurity(entry);
        ...
        /// </returns>
        public virtual List<Dimension> GetList(IConnectionManager entry, RecordIdentifier itemID, int sortColumn, bool backwardsSort)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                string sort;
                ...
                return Execute<Dimension>(entry, cmd, CommandType.Text, PopulateDimension);
            }
        }
        ...
        /// </returns>
        public virtual List<DimensionCombination> GetCreatableDimensionCombinations(IConnectionManager entry, RecordIdentifier itemID)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ValidateSecurity(entry);
                ...
                return Execute<DimensionCombination>(entry, cmd, CommandType.Text, PopulateDimensionCombination);
            }
        }
        ...
        public virtual void Delete(IConnectionManager entry, RecordIdentifier dimensionQuadID)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ...
                DeleteRecord(entry, "INVENTDIMCOMBINATION", new[] { "ITEMID", "INVENTSIZEID", "INVENTCOLORID", "INVENTSTYLEID" }, dimensionQuadID, BusinessObjects.Permission.ColorSizeStyleEdit);
            }
        }
        ...
        public virtual void DeleteAllDimensionCombinations(IConnectionManager entry, RecordIdentifier itemID)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ...
                DeleteRecord(entry, "INVENTDIMCOMBINATION", "ITEMID", itemID, BusinessObjects.Permission.ColorSizeStyleEdit);
            }
        }
        ...
        public virtual void Save(IConnectionManager entry,Dimension dimension,RecordIdentifier existingID)
        {
            ...
            {
                dimension.DimensionID = DataProviderFactory.Instance.GenerateNumber<IDimensionData, Dimension>(entry); 
            }
        ...
        private bool InventDimCombinationExists(IConnectionManager entry, Dimension dimension)
        {
        ...
        /// <param name="entry">The entry into the database</param>
        /// <param name="dimension">The dimension data to be saved</param>
        public virtual void Save(IConnectionManager entry, Dimension dimension)
        {
