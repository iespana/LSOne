...
{
    public interface IDiscountOfferData : IDataProviderBase<DiscountOffer>, ISequenceable
    {
        /// <summary>
        ...
        string GetFromBarcode(IConnectionManager entry, string barcode);
        ...
        List<DiscountOffer> GetOffers(IConnectionManager entry, DiscountOffer.PeriodicDiscountOfferTypeEnum type, int sortColumn, bool backwardsSort);
        ...
        void Delete(IConnectionManager entry, RecordIdentifier offerID);
        ...
        bool Exists(IConnectionManager entry, RecordIdentifier offerID);

        bool BarcodeExists(IConnectionManager entry, RecordIdentifier barcode);
    }
}