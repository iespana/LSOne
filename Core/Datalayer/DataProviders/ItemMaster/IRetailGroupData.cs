...
{
    public interface IRetailGroupData : IDataProvider<RetailGroup>, ICompareListGetter<RetailGroup>, ISequenceable
    {
        /// <summary>
        ...
        /// <param name="sort">The sort column</param>
         List<MasterIDEntity> SearchMasterID(
      ...
      //  Guid GetMasterID(IConnectionManager entry, RecordIdentifier ID);
       ...
       // string GetReadableID(IConnectionManager entry, RecordIdentifier ID);
        ...
        List<ItemInGroup> ItemsInGroup(IConnectionManager entry, RecordIdentifier groupId, int recordFrom,
            int recordTo);
        ...
        /// <param name="groupId">Id of the retail group</param>
        /// <returns>A list of data entities containing IDs and names of retail items in a given retail group meeting the above criteria</returns>
        List<ItemInGroup> ItemsInGroup(IConnectionManager entry, RecordIdentifier groupId);
        ...
        void AddItemToRetailGroup(IConnectionManager entry, RecordIdentifier itemId, RecordIdentifier groupId);
        ...
        /// <param name="groupId">The ID of the retail group to add an item to</param>
        void AddItemsToRetailGroup(IConnectionManager entry, List<RecordIdentifier> itemIDs, RecordIdentifier groupId);
        ...
        /// <param name="retailDepartmentID">The unique ID of the retail department</param>
        void AddRetailGroupsToRetailDepartment(IConnectionManager entry, List<RecordIdentifier> retailGroupIDs, RecordIdentifier retailDepartmentID);
        ...
        void Undelete(IConnectionManager entry, RecordIdentifier groupID);
        ...
        bool IsDeleted(IConnectionManager entry, RecordIdentifier groupID);
    }
}