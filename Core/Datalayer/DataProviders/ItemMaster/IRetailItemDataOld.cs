...
{
    public interface IRetailItemDataOld : IDataProvider<RetailItemOld>, ISequenceable
    {
        /// <summary>
        ...
        RecordIdentifier GetItemUnitID(IConnectionManager entry, RecordIdentifier itemID, RetailItemOld.ModuleTypeEnum module);
        ...
        /// sales)</param>
        void UpdateUnitID(IConnectionManager entry, RecordIdentifier itemID, RecordIdentifier unitID, RetailItemOld.ModuleTypeEnum module);
        ...
        List<ItemListItemOld> Search(IConnectionManager entry, string searchString, int rowFrom, int rowTo, bool beginsWith, string sort);
        ...
        List<ItemListItemOld> AdvancedSearchOptimized(IConnectionManager entry,
        ...
        List<ItemListItemOld> AdvancedSearch(IConnectionManager entry,
            int rowFrom, int rowTo, string sort,
            out int totalRecordsMatching,
            string idOrDescription = null,
            bool idOrDescriptionBeginsWith = true,
        ...
        /// <returns></returns>
        List<ItemListItemOld> AdvancedSearch(IConnectionManager entry, string searchString, int rowFrom, int rowTo, bool beginsWith, string sort, Dictionary<RetailItemSearchEnum, string> advancedSearchParameters);
        ...
        List<RetailItemOld> GetItemsByItemPattern(IConnectionManager entry, string itemID);
        ...
        /// <param name="entry">Entry into the database</param>
        /// <returns>The retail item, or null if not found</returns>
        List<RetailItemOld> GetAllItems(IConnectionManager entry);
        ...
        bool ItemHasDimentionGroup(IConnectionManager entry, ItemListItemOld itemID);
        ...
        RetailItemOld.RetailItemModule GetPriceModule(IConnectionManager entry, RecordIdentifier itemID);
        ...
        void ResequenceImages(IConnectionManager entry, List<ItemImage> itemImages);
        ...
        RetailItemOld Get(IConnectionManager entry, RecordIdentifier ID, CacheType cacheType = CacheType.CacheTypeNone);
