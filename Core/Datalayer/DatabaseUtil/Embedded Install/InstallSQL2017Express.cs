...
namespace LSOne.DataLayer.DatabaseUtil.EmbeddedInstall
{
    ...
    /// 
    /// </summary>
    public class InstallSQL2017Express : InstallSQLExpress
    {
        /// <summary>
        /// When using the InstallSQL2017Express, the program can subscribe to the MessageCallback function which will receive information about progress and what is going on within the class. 
        /// This is done instead of having a user interface with progress information.
        /// </summary>
        public event InstallingSQL2017MessageCallback MessageCallbackHandler;

        /// <summary>
        /// The parameters required to install the SQL 2017 Express server quietly. Default parameters can be changed before installation.
        /// </summary>
        public SQL2017Params SQLParameters { get; set; }
        ...
        /// </summary>
        /// <param name="SQLParameters">The SQL 2017 parameters that should be used when installing the SQL Server</param>
        public InstallSQL2017Express(SQL2017Params SQLParameters)
        {
        ...
        public override void SendMessage(string msg)
        {
            ...
            {
                MessageCallbackHandler(Resources.SenderInstallSQL2017, msg);
            }
        }
        ...
        /// <summary>
        /// Installs SQL 2017 SQLExpress. If the installation files (SetupFileLocation) don't exist a DatabaseUtilityException is thrown.
        /// </summary>
        ...
        private string BuildCommandLine()
        {
            ...
            {
                strCommandLine.Append(" /SQLSVCACCOUNT=\"").Append(Resources.NetworkService).Append("\"");
            }
            ...
            {
                strCommandLine.Append(" /AGTSVCACCOUNT=\"").Append(Resources.NetworkService).Append("\"");
            }
            else
            {
