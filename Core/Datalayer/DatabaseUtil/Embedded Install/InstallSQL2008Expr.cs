...
{
    /// <summary>
    /// A class that installs SQL 2008 Express server. It builds the command line from parameters defined in SQL2005Params
    /// </summary>
    public class InstallSQL2008Expr : InstallSQLExpress
    {
        /// <summary>
        ...
        /// </summary>
        public SQL2008Params SQLParameters { get; set; }
        ...
        public InstallSQL2008Expr(SQL2008Params SQLParameters) : base()
        {
        ...
        {         
            ...
            strCommandLine.Append(" /INSTANCENAME=\"").Append(SQLParameters.InstanceName.ToUpper()).Append("\"");
