...
{
    /// <summary>
    /// All parameters available to use when installing SQL 2017 Express server. The parameters that have to be used during the install all have default values.
    /// </summary>
    public class SQL2017Params : SQLParams
    {
        ...
        /// </summary>
        public SQL2017Params(string SetupFileLocation)
