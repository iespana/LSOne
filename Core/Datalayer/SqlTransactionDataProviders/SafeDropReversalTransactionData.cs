...
{
    public class SafeDropReversalTransactionData : SqlServerDataProviderBase, ISafeDropReversalTransactionData
    {
        public virtual void Insert(IConnectionManager entry, TenderLineItem tenderItem, SafeDropReversalTransaction transaction)
        {
