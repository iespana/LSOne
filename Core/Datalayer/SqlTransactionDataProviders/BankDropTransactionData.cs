...
{
    public class BankDropTransactionData : SqlServerDataProviderBase, IBankDropTransactionData
    {
        public virtual void Insert(IConnectionManager entry, TenderLineItem tenderItem, BankDropTransaction transaction)
        {
