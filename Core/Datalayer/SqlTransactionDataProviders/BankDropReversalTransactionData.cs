...
{
    public class BankDropReversalTransactionData : SqlServerDataProviderBase, IBankDropReversalTransactionData
    {
        public virtual void Insert(IConnectionManager entry,TenderLineItem tenderItem, BankDropReversalTransaction transaction)
        {
            ValidateSecurity(entry);

            var statement = new SqlServerStatement("RBOTRANSACTIONBANKEDTENDE20338", StatementType.Insert, false);
            ...
            statement.AddField("AMOUNTMSTPOS", tenderItem.CompanyCurrencyAmount * -1, SqlDbType.Decimal);
            statement.AddField("AMOUNTCUR", tenderItem.ForeignCurrencyAmount * -1, SqlDbType.Decimal);
            statement.AddField("AMOUNTCURPOS", tenderItem.ForeignCurrencyAmount * -1, SqlDbType.Decimal);
            statement.AddField("AMOUNTTENDERED", tenderItem.Amount * -1, SqlDbType.Decimal);
            statement.AddField("AMOUNTTENDEREDPOS", tenderItem.Amount * -1, SqlDbType.Decimal);
            ...
            statement.AddField("BANKBAGNO", transaction.BankBagNo);
