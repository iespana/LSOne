...
namespace LSOne.DataLayer.BusinessObjects.ItemMaster.Dimensions
{
    ...
    /// </summary>
    public class Dimension : DimensionCombination, ICloneable
    {
        ...
        protected void Populate(Dimension dimensions)
        {
            ...
            try
            {
               ...
               */
                XElement xDimension = new XElement("Dimensions",
                    ...
                    new XElement("enterDimensions", Conversion.ToXmlString(EnterDimensions))
                );
                                    ...
                                    try
                                    {
                                        switch (xVariable.Name.ToString())
                                        {
                                            ...
                                            case "enterDimensions":
                                                EnterDimensions = Conversion.XmlStringToBool(xVariable.Value);
                                                break;
                                        }
                                    }
                                    catch (Exception ex)
