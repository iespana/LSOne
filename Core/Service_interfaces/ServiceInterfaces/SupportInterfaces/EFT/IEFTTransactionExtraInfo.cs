...
{
    /// <summary>
    /// Defines an object that is stored on a <see cref="IRetailTransaction"/> and adds transaction-level information for an EFT integration
    /// </summary>
    public interface IEFTTransactionExtraInfo
    {
        /// <summary>
