...
namespace LSOne.Services.Interfaces
{
    public partial interface ISiteServiceService
	{
		...
		InventoryJournalTransaction GetInventoryJournalTransaction(IConnectionManager entry, SiteServiceProfile siteServiceProfile, RecordIdentifier journalTransactionId, bool closeConnection);
		...
		List<ImportLogItem> ImportStockCountingFromExcel(IConnectionManager entry, SiteServiceProfile siteServiceProfile, DataTable data, bool closeConnection);
