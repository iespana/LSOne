...
namespace LSOne.Services.Interfaces
{
	public partial interface IInventoryService : IService
	{
		...
		List<InventoryTemplateListItem> GetInventoryTemplateListForStore(IConnectionManager entry, SiteServiceProfile siteServiceProfile, InventoryTemplateListFilter filter, RecordIdentifier storeID, bool closeConnection);
		...
		List<InventoryAreaLineListItem> GetInventoryAreaLinesListItems(IConnectionManager entry, SiteServiceProfile siteSrviceProfile, bool closeConnection);
