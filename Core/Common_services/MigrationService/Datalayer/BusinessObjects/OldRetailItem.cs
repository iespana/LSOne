...
using ItemListItem = LSOne.Services.Datalayer.BusinessObjects.ListItems.OldItemListItem;
...
namespace LSOne.Services.Datalayer.BusinessObjects
{
    ...
    /// </summary>
    public partial class OldRetailItem : ItemListItem
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Items that should not be available on the POS
            /// </summary>
            NA = -1,
            /// <summary>
        ...
        /// </summary>
        public enum OldRetailItemTypeEnum
        {
            /// <summary>
        ...
        // From RBOINVENTTABLE
        OldRetailItemTypeEnum retailItemType;
            ...
            : base()
        {
            ...
            retailItemType = OldRetailItemTypeEnum.RetailItem;
        ...
        /// Not currently used.
        /// </summary>
        public OldRetailItemTypeEnum RetailItemType
        {
                    ...
                    try
                    {
                        switch (current.Name.ToString())
                        {
                            ...
                            case "dimensionGroupName":
                                ...
                                break;
                            case "retailItemType":
                                RetailItemType = (OldRetailItemTypeEnum)Convert.ToInt32(current.Value);
                                break;
