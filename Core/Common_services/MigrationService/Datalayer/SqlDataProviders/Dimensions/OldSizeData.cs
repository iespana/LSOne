...
namespace LSOne.Services.Datalayer.SqlDataProviders.Dimensions
{
    ...
    /// </summary>
    public class OldSizeData : SqlServerDataProviderBase, IOldSizeData
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OldSizeData"/> class.
        /// </summary>
        ...
        private static void PopulateSize(IDataReader dr, OldItemWithDescription size)
        {
        ...
        public virtual OldItemWithDescription GetSize(IConnectionManager entry, RecordIdentifier sizeID)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ...
                var items = Execute<OldItemWithDescription>(entry, cmd, CommandType.Text, PopulateSize);
                return (items.Count > 0) ? items[0] : null;
            }
        }

        private static void PopulateSizeGroupLine(IDataReader dr, OldStyleGroupLineItem item)
        {
        ...
        public virtual List<OldStyleGroupLineItem> GetGroupLines(IConnectionManager entry, RecordIdentifier groupID, string sort)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ...
                return Execute<OldStyleGroupLineItem>(entry, cmd, CommandType.Text, PopulateSizeGroupLine);
            }
        }
        ...
        public virtual OldStyleGroupLineItem GetGroupLine(IConnectionManager entry, RecordIdentifier groupID, RecordIdentifier sizeID)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                //ValidateSecurity(entry, BusinessObjects.Permission.CustomerView);
                ...
                var items = Execute<OldStyleGroupLineItem>(entry, cmd, CommandType.Text, PopulateSizeGroupLine);
        ...
        {
            DeleteRecord(entry, "RBOSIZES", "SIZE_", sizeID, DataLayer.BusinessObjects.Permission.ColorSizeStyleEdit);
        }
        ...
        {
            DeleteRecord(entry, "RBOSIZEGROUPTABLE", "SIZEGROUP", sizeGroupID, DataLayer.BusinessObjects.Permission.ColorSizeStyleEdit);
            DeleteRecord(entry, "RBOSIZEGROUPTRANS", "SIZEGROUP", sizeGroupID, DataLayer.BusinessObjects.Permission.ColorSizeStyleEdit);
        }
        ...
        {
            DeleteRecord(entry, "RBOSIZEGROUPTRANS", new[] { "Size_", "Sizegroup" }, groupLineID, DataLayer.BusinessObjects.Permission.ColorSizeStyleEdit);
        }
        ...
        public virtual void SaveSize(IConnectionManager entry, OldItemWithDescription size)
        {
