...
namespace LSOne.Services.Datalayer.SqlDataProviders
{
    ...
    /// </summary>
    public class OldRetailDepartmentData : SqlServerDataProviderBase, IOldRetailDepartmentData
    {
        ...
        {
            DeleteRecord(entry, "RBOINVENTITEMDEPARTMENT", "DEPARTMENTID", departmentId, DataLayer.BusinessObjects.Permission.ManageRetailDepartments);
        }
        ...
        public virtual void Save(IConnectionManager entry, RetailDepartment retailDepartment)
        {
            ...
            ValidateSecurity(entry, DataLayer.BusinessObjects.Permission.ManageRetailDepartments);
