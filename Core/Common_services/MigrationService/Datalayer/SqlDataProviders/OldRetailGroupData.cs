...
namespace LSOne.Services.Datalayer.SqlDataProviders
{
    ...
    /// </summary>
    public class OldRetailGroupData : SqlServerDataProviderBase, DataProviders.IOldRetailGroupData
    {
        private static string BaseSql
        {
            get
            {
                return "Select a.GROUPID as GROUPID, ISNULL(a.NAME,'') AS NAME, ISNULL(a.DEFAULTPROFIT,0) AS DEFAULTPROFIT, " +
        ...
        {
            DeleteRecord(entry, "RBOINVENTITEMRETAILGROUP", "GROUPID", groupID, Permission.ManageRetailGroups);
        }
