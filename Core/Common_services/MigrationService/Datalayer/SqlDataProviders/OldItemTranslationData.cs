...
{
    public class OldItemTranslationData : SqlServerDataProviderBase, IOldItemTranslationData
    {
        private static void ItemTranslationPopulator(IDataReader dr, OldItemTranslation itemTranslation)
        {
        ...
        public virtual OldItemTranslation Get(IConnectionManager entry, RecordIdentifier itemTranslationID, CacheType cacheType = CacheType.CacheTypeNone)
        {
            using (var cmd = entry.Connection.CreateCommand())
            {
                ...
                return Get< OldItemTranslation>(entry, cmd, itemTranslationID, ItemTranslationPopulator, cacheType, UsageIntentEnum.Normal);
            }
        }

        public virtual List< OldItemTranslation> GetList(IConnectionManager entry, RecordIdentifier itemID, CacheType cacheType = CacheType.CacheTypeNone)
        {
            ...
            using (var cmd = entry.Connection.CreateCommand())
            {
                ...
                return GetList< OldItemTranslation>(entry, cmd, id, ItemTranslationPopulator, cacheType);
            }
        }

        public virtual List< OldItemTranslation> GetListByCultureName(IConnectionManager entry, string cultureName, CacheType cacheType = CacheType.CacheTypeNone)
        {
        ...
        {
            DeleteRecord(entry, "RBOINVENTTRANSLATIONS", "ID", itemTranslationID, DataLayer.BusinessObjects.Permission.ItemsEdit);
        }

        public virtual void Save(IConnectionManager entry,  OldItemTranslation itemTranslation)
        {
