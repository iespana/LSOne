...
using DDConfigCommands = LSOne.Services.Utils.DDConfigCommands;
using IComConfig = LSOne.Services.Utils.IComConfig;
...
namespace LSOne.Services
{
    public class SchedulerClient : IDisposable
    {
        ...
        private string RunConfigCommand(string configValue)
        {
            ...
            string resultMsg = comConfig.SendConfigCmd(DDConfigCommands.SchedulerCmd, string.Empty, configValue);
